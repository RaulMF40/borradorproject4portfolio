    ...
    additionalCertifications: [
      {
        ...
        year: 2013,
        description:
          'Completed a comprehensive program covering frontend and backend development, including HTML, CSS, JavaScript, React, Node.js, and database management.'
      },
      {
        ...
        year: 2015,
        description:
          'Learned advanced photography techniques and image editing using Adobe Photoshop and Lightroom.'
      },
      {
        ...
        year: 2016,
        description:
          'Focused on the principles and practices of digital journalism, including multimedia storytelling and investigative reporting.'
      }
    ],
    workshops: [
      {
        ...
        year: 2014,
        description:
          'A hands-on workshop covering modern web design principles and practices, including responsive design and UX/UI best practices.'
      },
      {
        ...
        year: 2015,
        description:
          'An in-depth workshop on advanced JavaScript concepts, including ES6+ features, asynchronous programming, and modern frameworks.'
      }
    ]
  },
  workExperience: [
